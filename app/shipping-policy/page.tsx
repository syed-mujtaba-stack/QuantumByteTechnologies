  ...
  return (
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <article className="rounded-2xl border border-[white/[0.06]] bg-[#080B12] p-8 sm:p-10 space-y-8">
            <header className="border-b border-[white/[0.06]] pb-6">
              ...
              <p className="text-sm text-[#64748B] mt-1">Anti-Static Protection • Insured Courier Logistics • Nationwide Coverage</p>
            </header>
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#94A3B8] leading-relaxed">We use a multi-layer packaging system designed for sensitive electronics:</p>
              <div className="grid gap-4 mt-4">
                <div className="bg-[white/[0.04]] border border-[white/[0.06]] rounded-xl p-5 space-y-2">
                  ...
                  <p className="text-sm text-[#94A3B8] ml-13">Pink poly ESD bags (MIL-PRF-81705 compliant) for all components: GPUs, RAM, SSDs, motherboards, CPUs. Static-shielding for transit protection.</p>
                </div>
                ...
                <div className="bg-[white/[0.04]] border border-[white/[0.06]] rounded-xl p-5 space-y-2">
                  ...
                  <p className="text-sm text-[#94A3B8] ml-13">Pink anti-static bubble wrap (3/16" bubbles) wrapped 2x around each component. Prevents mechanical shock and static discharge.</p>
                </div>
                ...
                <div className="bg-[white/[0.04]] border border-[white/[0.06]] rounded-xl p-5 space-y-2">
                  ...
                  <p className="text-sm text-[#94A3B8] ml-13">High-density polyethylene foam (2.2 lb/ft³) precision-cut for GPUs, MacBooks, monitors. Eliminates movement within box.</p>
                </div>
                ...
                <div className="bg-[white/[0.04]] border border-[white/[0.06]] rounded-xl p-5 space-y-2">
                  ...
                  <p className="text-sm text-[#94A3B8] ml-13">275 lb test double-wall corrugated (ECT-48). Reinforced corners. Tamper-evident security tape with QuantumByte branding.</p>
                </div>
                ...
                <div className="bg-[white/[0.04]] border border-[white/[0.06]] rounded-xl p-5 space-y-2">
                  ...
                  <p className="text-sm text-[#94A3B8] ml-13">ISPM-15 heat-treated pine crates with foam suspension. Steel banding. "This Side Up" and "Fragile" markings. Forklift-ready.</p>
                </div>
              </div>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="bg-[white/[0.04]] border border-[#3B82F6]/30 rounded-xl p-5 space-y-3">
                <div className="flex items-center gap-3">
                  <ShieldCheck className="h-6 w-6 text-[#3B82F6]" />
                  <div>
                    <p className="font-bold text-white text-lg">Free Insured Express Shipping</p>
                    <p className="text-sm text-[#94A3B8]">On all orders ≥ <span className="text-[#3B82F6] font-black">Rs. 27,900</span></p>
                  </div>
                </div>
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#94A3B8] leading-relaxed">We partner with Pakistan's most reliable logistics providers:</p>
              ...
              <p className="text-[#94A3B8] leading-relaxed mt-4">
                Tracking numbers emailed and SMS'd instantly upon dispatch. Track at <a href="https://quantumbyte.tech/track-order" className="text-[#3B82F6] hover:underline">quantumbyte.tech/track-order</a> or courier website. COD orders: verification call before dispatch.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="bg-[white/[0.04]] border border-[white/[0.06]] rounded-lg p-4">
                  ...
                  <ol className="list-decimal list-inside space-y-1 text-sm text-[#94A3B8] leading-relaxed">
                ...
                <div className="bg-[white/[0.04]] border border-[#3B82F6]/30 rounded-lg p-4">
                  <div className="flex items-center gap-3">
                    <AlertTriangle className="h-5 w-5 text-[#3B82F6]" />
                    <div>
                      <p className="font-semibold text-white">COD Limits & Restrictions</p>
                      <ul className="list-disc list-inside space-y-1 text-sm text-[#94A3B8] mt-1">
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#94A3B8] leading-relaxed">Upon delivery, please:</p>
              ...
              <div className="bg-[white/[0.04]] border border-[#3B82F6]/30 rounded-lg p-4 mt-4">
                <div className="flex items-center gap-3">
                  <AlertTriangle className="h-5 w-5 text-[#3B82F6]" />
                  <div>
                    <p className="font-semibold text-white">Important</p>
                    <p className="text-sm text-[#94A3B8] mt-1">Signing "Received in Good Condition" without inspection waives shipping damage claims. Always write "Subject to Inspection" on receipt if unable to open immediately.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#94A3B8] leading-relaxed">If package shows visible external damage:</p>
              <ol className="list-decimal list-inside space-y-2 text-[#94A3B8] leading-relaxed ml-4 mt-2">
    ...
    Currently, we ship <strong>within Pakistan only</strong>. For international inquiries (UAE, Saudi Arabia, UK, USA, EU), contact <a href="mailto:supportquantumbytetechnologies@gmail.com" className="text-[#3B82F6] hover:underline">supportquantumbytetechnologies@gmail.com</a> for custom quotes. International shipping involves customs duties, import taxes, and compliance certifications (CE, FCC, RoHS) which are buyer's responsibility.
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#94A3B8] leading-relaxed">During major holidays (Eid, Ramadan, Independence Day, Black Friday, New Year):</p>
              <ul className="list-disc list-inside space-y-2 text-[#94A3B8] leading-relaxed ml-4 mt-2">
              ...
              <div className="bg-[white/[0.04]] border border-[white/[0.06]] rounded-xl p-6 space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#94A3B8]">Mon–Sat 10:00 AM – 8:00 PM PKT</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
