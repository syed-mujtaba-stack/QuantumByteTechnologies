    ...
    <div className="min-h-screen bg-[#050505] text-white flex flex-col font-sans selection:bg-[#3B82F6] selection:text-white">
      ...
      <main className="flex-1 py-16 lg:py-24 flex items-center justify-center cyber-grid-bg">
        <div className="mx-auto max-w-2xl px-4 w-full text-center space-y-6">
          <div className="rounded-2xl border border-[#3B82F6]/40 bg-[#0e0e12] p-8 shadow-2xl shadow-[#3B82F6]/20 glass-panel-red space-y-6">
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-[#3B82F6]/20 text-[#3B82F6] animate-bounce">
            ...
            <div className="rounded-xl border border-[#22222e] bg-[#050505] p-5 text-left text-xs space-y-2.5">
              <div className="flex justify-between border-b border-[#1f1f2b] pb-2.5 font-bold">
                ...
                <span className="text-[#3B82F6] font-mono text-sm">{orderId}</span>
              </div>
              ...
              <div className="flex justify-between">
                ...
                <span className="flex items-center gap-1 text-white font-bold">
                  <ShieldCheck className="h-3.5 w-3.5 text-[#3B82F6]" /> 1 Year QuantumByte Guarantee
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <button
                ...
                className="flex items-center justify-center gap-2 rounded-xl border border-[#22222e] bg-[#16161f] px-6 py-3.5 text-xs font-bold text-white hover:border-[#3B82F6]"
              >
              ...
              <Link
                href="/shop"
                className="red-gradient-btn flex-1 flex items-center justify-center gap-2 rounded-xl py-3.5 text-xs font-extrabold text-white shadow-xl shadow-[#3B82F6]/25"
              >
