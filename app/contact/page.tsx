        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-10 md:grid-cols-12">
            ...
            <div className="md:col-span-5 space-y-6">
              <div>
                ...
                <h1 className="text-3xl font-black text-white sm:text-4xl mt-1">
                  GET IN TOUCH WITH <span className="text-[#ff003c]">OUR LAB</span>
                </h1>
              ...
              <div className="space-y-4 text-xs">
                <div className="flex items-start gap-4 rounded-xl border border-[#22222e] bg-[#0e0e12] p-4 glass-panel">
                  ...
                  <div>
                    ...
                    <p className="text-[#a1a1aa] mt-0.5">Office No 7, Second Floor, AZ Mall Platform — Back Side Al-Fateh Kohinoor, Madina Town, Faisalabad, Punjab, Pakistan</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 rounded-xl border border-[#22222e] bg-[#0e0e12] p-4 glass-panel">
                  ...
                  <div>
                    ...
                    <p className="text-[#a1a1aa] mt-0.5">support@quantumbyte.tech</p>
                    <p className="text-[#a1a1aa]">sales@quantumbyte.tech</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 rounded-xl border border-[#22222e] bg-[#0e0e12] p-4 glass-panel">
                  ...
                  <div>
                    ...
                    <p className="text-[#a1a1aa] mt-0.5">+92 325 4803957</p>
                    <p className="text-[#a1a1aa]">+92 325 4803957 (WhatsApp 24/7)</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-7">
              <div className="rounded-2xl border border-[#22222e] bg-[#0e0e12] p-8 shadow-2xl glass-panel space-y-6">
                <h3 className="text-xl font-black text-white border-b border-[#1f1f2b] pb-4 flex items-center gap-2">
                  <MessageSquare className="h-5 w-5 text-[#ff003c]" />
                ...
                {submitted ? (
                  <div className="rounded-xl border border-[#22c55e]/40 bg-[#22c55e]/10 p-6 text-center text-xs text-[#22c55e] space-y-2">
                    ...
                    <p className="text-[#a1a1aa]">Our hardware support team will get back to you within 2 business hours.</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-xs font-bold text-[#a1a1aa] mb-1">Your Name *</label>
                        <input
                          type="text"
                          required
                          value={form.name}
                    ...
                    <div>
                      <label className="block text-xs font-bold text-[#a1a1aa] mb-1">Subject *</label>
                      <input
                        type="text"
                        required
                        value={form.subject}
                    ...
                    <div>
                      <label className="block text-xs font-bold text-[#a1a1aa] mb-1">Message Details *</label>
                      <textarea
                        rows={4}
                        required
                        value={form.message}
