    ...
    <div className="min-h-screen bg-[#050505] text-white flex flex-col font-sans selection:bg-[#ff003c] selection:text-white">
      ...
      <main className="flex-1 py-10 lg:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {/* Deals Banner */}
          <div className="rounded-2xl border border-[#ff003c]/40 bg-gradient-to-r from-[#ff003c]/20 via-[#0e0e12] to-[#0e0e12] p-8 mb-10 cyber-grid-bg shadow-2xl glass-panel-red">
            ...
            <h1 className="text-3xl font-black text-white sm:text-5xl">
              HOT FLASH <span className="text-[#ff003c] glow-red-text">DEALS & OFFERS</span>
            </h1>
            ...
            <div className="mt-6 flex items-center gap-4 text-xs font-bold">
              <span className="flex items-center gap-1.5 rounded-xl border border-[#ff003c]/50 bg-[#050505] px-3.5 py-2 text-white">
                <Clock className="h-4 w-4 text-[#ff003c]" /> Promo Code: <strong className="text-[#ff003c]">QUANTUM10</strong> (Extra 10% Off)
              </span>
            </div>
          </div>
