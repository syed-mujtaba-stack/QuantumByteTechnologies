        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <article className="rounded-2xl border border-[white/[0.06]] bg-[#080B12] p-8 sm:p-10 space-y-8">
            <header className="border-b border-[white/[0.06]] pb-6">
              ...
              <p className="text-sm text-[#64748B] mt-1">Effective Date: August 15, 2026</p>
            </header>

            <section className="space-y-4">
              <h2 className="text-lg font-bold text-white">1. Introduction & Scope</h2>
              <p className="text-[#94A3B8] leading-relaxed">
                QuantumByte Technologies ("we," "us," or "our") is committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your data when you visit our website <code className="text-[#3B82F6] bg-[white/[0.04]] px-1.5 py-0.5 rounded">quantumbyte.tech</code>, purchase hardware, book IT services, or interact with our services. By using our services, you agree to the collection and use of information in accordance with this policy.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#94A3B8] leading-relaxed">We use your personal data for the following purposes:</p>
              <ul className="list-disc list-inside space-y-2 text-[#94A3B8] leading-relaxed ml-4">
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#94A3B8] leading-relaxed">We may share your information with:</p>
              <ul className="list-disc list-inside space-y-2 text-[#94A3B8] leading-relaxed ml-4">
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#94A3B8] leading-relaxed">We implement industry-standard security measures:</p>
              <ul className="list-disc list-inside space-y-2 text-[#94A3B8] leading-relaxed ml-4">
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#94A3B8] leading-relaxed">We retain your personal information only as long as necessary:</p>
              <ul className="list-disc list-inside space-y-2 text-[#94A3B8] leading-relaxed ml-4">
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#94A3B8] leading-relaxed">Depending on your jurisdiction, you may have the right to:</p>
              <ul className="list-disc list-inside space-y-2 text-[#94A3B8] leading-relaxed ml-4">
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#94A3B8] leading-relaxed">We use cookies and similar technologies to:</p>
              <ul className="list-disc list-inside space-y-2 text-[#94A3B8] leading-relaxed ml-4">
