...
interface HyperspeedProps {
  effectOptions?: Partial<typeof DEFAULT_EFFECT_OPTIONS> & { colors?: Partial<(typeof DEFAULT_EFFECT_OPTIONS)['colors']> };
}
...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }: HyperspeedProps) => {
  ...
  useEffect(() => {
    ...
    class App {
      ...
      loadAssets() {
        // postprocessing v6 generates SMAA's area/search images internally.
