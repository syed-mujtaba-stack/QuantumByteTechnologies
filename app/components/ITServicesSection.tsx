...
export function ITServicesSection({ itServices }: ITServicesSectionProps) {
  ...
  return (
    <section className="border-y border-[#1a1a24] bg-[#030305] py-16 lg:py-24" aria-labelledby="services-heading">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-4 max-w-3xl mx-auto mb-16">
          ...
          <GSAPReveal direction="up" delay={0.15}>
            <h2 id="services-heading" className="text-3xl sm:text-4xl lg:text-5xl font-black text-white leading-tight">
          ...
          {itServices.map((service, index) => {
            ...
            return (
              <GSAPReveal key={service.id} direction="up" delay={0.2 + index * 0.08} distance={30}>
                <div className={`grid lg:grid-cols-12 gap-12 items-center ${isEven ? '' : 'lg:[grid-template-areas:_\"image_content\"]'}`}>
                  <div className={`relative aspect-[4/3] overflow-hidden rounded-2xl bg-[#08080c] ${isEven ? 'lg:col-span-7' : 'lg:col-span-7 lg:col-start-6'}`}>
                    <Image
                  ...
                  <div className={`lg:col-span-5 ${isEven ? 'lg:col-start-8' : 'lg:col-start-1'} space-y-6 p-4 lg:p-0`}>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-[#1a1a24]">
                      ...
                      <button
                        ...
                        className="btn btn-primary justify-center gap-2 whitespace-nowrap"
                      >
                        Book Service
