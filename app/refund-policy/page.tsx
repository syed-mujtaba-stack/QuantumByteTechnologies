        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <article className="rounded-2xl border border-[#1a1a24] bg-[#08080c] p-8 sm:p-10 space-y-8">
            ...
            <section className="space-y-4">
              ...
              <ol className="list-decimal list-inside space-y-3 text-[#9c9ca8] leading-relaxed ml-4 mt-2">
            ...
            <section className="space-y-4">
              ...
              <p className="text-sm text-[#6b6b7a] mt-2">
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#9c9ca8] leading-relaxed">All retail products carry a <strong>1-year QuantumByte warranty</strong> from delivery date, covering:</p>
              <ul className="list-disc list-inside space-y-2 text-[#9c9ca8] leading-relaxed ml-4 mt-2">
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#9c9ca8] leading-relaxed">In addition to our 1-year warranty, products carry their respective manufacturer warranties:</p>
              <div className="grid gap-3 sm:grid-cols-2 mt-2">
                <div className="bg-[#0a0a10] border border-[#1a1a24] rounded-lg p-4">
                  <p className="font-semibold text-white">Apple</p>
                  <p className="text-sm text-[#9c9ca8] mt-1">1-year limited warranty + 90-day phone support. AppleCare+ available.</p>
                </div>
                <div className="bg-[#0a0a10] border border-[#1a1a24] rounded-lg p-4">
                  <p className="font-semibold text-white">ASUS / ROG</p>
                  <p className="text-sm text-[#9c9ca8] mt-1">3-year warranty on motherboards/GPUs (region dependent). ROG extended available.</p>
                </div>
                <div className="bg-[#0a0a10] border border-[#1a1a24] rounded-lg p-4">
                  <p className="font-semibold text-white">NVIDIA (Founders Edition)</p>
                  <p className="text-sm text-[#9c9ca8] mt-1">3-year limited warranty. AIB partner cards follow their brand terms.</p>
                </div>
                <div className="bg-[#0a0a10] border border-[#1a1a24] rounded-lg p-4">
                  <p className="font-semibold text-white">Samsung / WD / Crucial (Storage)</p>
                  <p className="text-sm text-[#9c9ca8] mt-1">3-5 years limited warranty (TBW limits apply). Data recovery not covered.</p>
                </div>
                <div className="bg-[#0a0a10] border border-[#1a1a24] rounded-lg p-4">
                  <p className="font-semibold text-white">Corsair / G.Skill / Kingston (RAM)</p>
                  <p className="text-sm text-[#9c9ca8] mt-1">Lifetime limited warranty. Physical damage excluded.</p>
                </div>
                <div className="bg-[#0a0a10] border border-[#1a1a24] rounded-lg p-4">
                  <p className="font-semibold text-white">Seasonic / Corsair / EVGA (PSU)</p>
                  <p className="text-sm text-[#9c9ca8] mt-1">5-10 years depending on series. Fan noise after 2 years not covered.</p>
                </div>
              </div>
              ...
              <div className="bg-[#0a0a10] border border-[#1a1a24] rounded-xl p-6 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#9c9ca8]">returns@quantumbyte.tech</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  <RotateCcw className="h-5 w-5 text-[#ff003c]" />
                  <div>
                    <p className="font-semibold text-white">Warranty & Repair Lab</p>
                    <p className="text-sm text-[#9c9ca8]">warranty@quantumbyte.tech</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle2 className="h-5 w-5 text-[#ff003c]" />
                  <div>
