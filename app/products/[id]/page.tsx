        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-10 md:grid-cols-12 mb-16">
            ...
            <div className="md:col-span-6 space-y-4">
              <div className="relative h-96 w-full overflow-hidden rounded-2xl border border-[#ff003c]/40 bg-[#0e0e12] p-4 glass-panel-red shadow-2xl">
                <Image
                  ...
                  priority
                />
                <span className="absolute top-4 left-4 rounded-md bg-[#ff003c] px-3 py-1 text-xs font-extrabold text-white">
                  {product.brand}
                </span>
              </div>
            ...
            <div className="md:col-span-6 space-y-6">
              ...
              <div className="flex items-baseline gap-4 rounded-xl border border-[#22222e] bg-[#0e0e12] p-4">
                ...
                {product.discountPrice && (
                  <span className="rounded bg-[#ff003c]/20 px-2.5 py-1 text-xs font-bold text-[#ff003c]">
              ...
              <div className="space-y-3 pt-4 border-t border-[#1f1f2b]">
                <h4 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2">
                  <Cpu className="h-4 w-4 text-[#ff003c]" /> Technical Specifications
                </h4>
          ...
          {relatedProducts.length > 0 && (
            <div className="pt-12 border-t border-[#1f1f2b] space-y-6">
              <h3 className="text-2xl font-black text-white">
                SIMILAR <span className="text-[#ff003c]">RECOMMENDATIONS</span>
              </h3>
