        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center space-y-3 mb-12">
            ...
            <h1 className="text-3xl font-black text-white sm:text-5xl">
              PRODUCT <span className="text-[#3B82F6] glow-red-text">CATEGORIES</span>
            </h1>
              ...
              return (
                <GSAPFadeIn key={cat.slug} direction="up" delay={0.1 * idx}>
                  <GSAPHoverTilt className="h-full">
                    <Link href={`/categories/${cat.slug}`} className="group flex h-full flex-col justify-between rounded-2xl border border-[#22222e] bg-[#0e0e12] p-5 transition hover:border-[#3B82F6]/60 hover:bg-[#12121a] hover:shadow-xl hover:shadow-[#3B82F6]/15 glass-panel">
                      <div className="space-y-4">
                        <div className="relative h-44 w-full overflow-hidden rounded-xl bg-[#050505]">
                          ...
                          />
                          <div className="absolute top-3 left-3 flex h-9 w-9 items-center justify-center rounded-xl bg-[#3B82F6] text-white shadow-lg">
                        ...
                        <div>
                          <div className="flex items-center justify-between text-xs mb-1">
                            <span className="font-extrabold text-[#3B82F6] uppercase">{count} Products</span>
                          </div>
                          <h3 className="text-lg font-black text-white group-hover:text-[#3B82F6] transition">
                            {cat.title}
                          </h3>
                      ...
                      <div className="mt-6 flex items-center justify-between pt-3 border-t border-[#1f1f2b] text-xs font-bold text-white group-hover:text-[#3B82F6]">
