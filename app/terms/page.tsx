        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <article className="rounded-2xl border border-[#1a1a24] bg-[#08080c] p-8 sm:p-10 space-y-8">
            <header className="border-b border-[#1a1a24] pb-6">
              ...
              <p className="text-sm text-[#6b6b7a] mt-2">Effective Date: August 15, 2026</p>
              <p className="text-sm text-[#6b6b7a] mt-1">Last Updated: August 15, 2026</p>
            </header>

            <section className="space-y-4">
              <h2 className="text-lg font-bold text-white">1. Acceptance of Terms</h2>
              <p className="text-[#9c9ca8] leading-relaxed">
                By accessing <code className="text-[#ff003c] bg-[#0a0a10] px-1.5 py-0.5 rounded">quantumbyte.tech</code>, creating an account, placing an order, or booking a service, you agree to be bound by these Terms & Conditions ("Terms"), our Privacy Policy, and all applicable laws. If you do not agree, please do not use our services.
              </p>
            </section>

            <section className="space-y-4">
              <h2 className="text-lg font-bold text-white">2. Definitions</h2>
              <dl className="space-y-2 text-[#9c9ca8] leading-relaxed">
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#9c9ca8] leading-relaxed mt-2">
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#9c9ca8] leading-relaxed mt-2">
                See our <Link href="/refund-policy" className="text-[#ff003c] hover:underline">Refund Policy</Link> and <Link href="/shipping-policy" className="text-[#ff003c] hover:underline">Shipping Policy</Link> for detailed terms. Summary:
              </p>
            ...
            <section className="space-y-4">
              ...
              <p className="text-[#9c9ca8] leading-relaxed mt-2">You agree not to:</p>
              <ul className="list-disc list-inside space-y-2 text-[#9c9ca8] leading-relaxed ml-4 mt-2">
            ...
            <section className="space-y-4">
              ...
              <div className="bg-[#0a0a10] border border-[#1a1a24] rounded-xl p-6 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto:legal@quantumbyte.tech" className="text-[#ff003c] hover:underline">legal@quantumbyte.tech</a>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-[#ff003c]">📞</span>
